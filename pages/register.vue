          ...
          >
            ...
            >
              <div class="mb-6">
                ...
                <div class="mt-1 flex">
                  ...
                  <div class="-ml-8 mt-2 text-right text-md text-gray-500">
                    <span v-if="visibility2 == 'password'"
                      ><div @click="showPassword2()">
                        <i class="far fa-eye-slash"></i></div
                    ></span>
                    <span v-if="visibility2 == 'text'"
                      ><div @click="hidePassword2()">
                        <i class="far fa-eye"></i></div
                    ></span>
                  </div>
                </div>
            ...
            <div class="mb-4 mt-6">
              <div class="text-sm text-center text-gray-600 mb-4">
                By clicking on the button below, you agree to our
                <NuxtLink to="#" class="text-red-300"
  ...
  meta: [
    {
      hid: "description",
      name: "description",
      content: "Please complete this form correctly to register.",
    },
  ],
  data() {
    return {
